...
// MockSource is a mock implementation of Source interface
...
func (m *MockSource) GetStringDiffWithTarget(tgt Target) string {
	args := m.Called(tgt)
	return args.String(0)
}

func (m *MockSource) SameProgressWithTarget(tgt Target) bool {
	args := m.Called(tgt)
	return args.Bool(0)
}

func (m *MockSource) SameTypeWithTarget(tgt Target) bool {
	args := m.Called(tgt)
	return args.Bool(0)
}

func (m *MockSource) SameTitleWithTarget(tgt Target) bool {
	args := m.Called(tgt)
	return args.Bool(0)
}
...
// MockTarget is a mock implementation of Target interface
