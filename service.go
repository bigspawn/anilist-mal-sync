...
func NewAniListAnimeService(client *AnilistClient, scoreFormat verniy.ScoreFormat) *AniListAnimeService {
...
func NewAniListMangaService(client *AnilistClient, scoreFormat verniy.ScoreFormat) *AniListMangaService {
